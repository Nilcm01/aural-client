...
const MAX_NEW_RELEASES = 2;

export default function NewReleases () {
    return (
        <ScrollView horizontal style={{ flexDirection: "row", paddingVertical: 10}}>
            <View style={{ display: "flex", flexDirection: "row" , marginLeft: 10}}>
            {Array.from({ length: MAX_NEW_RELEASES }).map((_, counter) => (
            <View key={counter} style={{ display: "flex", flexDirection: "column", justifyContent: "center", margin: 10}} >
